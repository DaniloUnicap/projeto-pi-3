  ...
  return (
    <div className="px-4 md:px-16">
      {questions.map((q, index) => (
        <div 
          className={`mb-6 p-4 rounded ${feedback[index] === 'correct' ? 'bg-green-400' : feedback[index] === 'incorrect' ? 'bg-red-400' : `${theme === "light" ? "bg-[#EBEBEF] text-black" : "bg-[#37373C] text-white"}`} `} 
          key={index}
        >
